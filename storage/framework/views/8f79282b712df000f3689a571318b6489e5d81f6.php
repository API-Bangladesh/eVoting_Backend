                ...
                <div class="block" style="display: none;">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group <?php echo e($errors->has('queue_driver') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="queue_driver" id="queue_driver" value="database" placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_tabs.queue_placeholder')); ?>" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\eVoting_Backend\resources\views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>