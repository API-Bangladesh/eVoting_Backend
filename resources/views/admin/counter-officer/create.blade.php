...
@section('title', 'Create Counter Officer')
...
@section('content')
    <main id="dashboard">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('store-counter-officer') }}" method="post"
                        ...
                        <div class="text-lg-end">
                            ...
                            <div class="row align-items-start form-group mb-3">
                                <label for="info" class="col-lg-3 col-form-label">Other Info:</label>
                                <div class="col flex-grow-1">
                                    <textarea class="form-control" placeholder="Write Information"
                                              name="info"
                        ...
                        <div class="offset-lg-3">
                            <button type="submit" class="btn btn-primary text-light px-4 rounded-pill">Create</button>
                        </div>
                    </form>
                </div>
            </div>
