...
@section('title', 'Edit Token Counter')
...
@section('content')
    <main id="dashboard">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('update-counter', $counter->id) }}" method="post"
                        ...
                        <div class="text-lg-end">
                            <div class="row align-items-center form-group mb-3">
                                ...
                                <div class="col flex-grow-1">
                                    <input type="text" class="form-control rounded-pill ps-4" id="counter_number"
                                           name="counter_number"
                                           value="{{ old('counter_number', $counter->counter_number) }}"
                            ...
                            <div class="row align-items-center form-group mb-3">
                                ...
                                <div class="col flex-grow-1">
                                    <select class="form-select form-control rounded-pill ps-4" name="officer_id" id="#">
                                        <option disabled selected> Select Counter Officer</option>
                                        @foreach(get_counter_officer_list() as $counterOfficer)
                                            <option
                                                @if($counterOfficer->id == old('counter_officer_id', $counter->counter_officer_id)) selected
                        ...
                        <div class="offset-lg-3">
                            <button type="submit" class="btn btn-primary text-light px-4 rounded-pill">Update</button>
                        </div>
                    </form>
                </div>
            </div>
